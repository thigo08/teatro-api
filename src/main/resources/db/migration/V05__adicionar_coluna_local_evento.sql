...
UPDATE local SET imagem = 'http://www.barbixas.com.br/2017/embrevesimg.jpg' WHERE id = 1;
UPDATE local SET imagem = 'http://www.desfrutecultural.com.br/wp-content/uploads/2015/02/G7-divulga%C3%A7ao.jpg' WHERE id = 2;
UPDATE local SET imagem = 'http://www.joaoalberto.com/wp-content/uploads/2015/05/22/melhores-do-mundo.jpg' WHERE id = 3;
